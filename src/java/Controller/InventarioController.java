...
import Models.InventarioFacade;
...
public class InventarioController implements Serializable {
    ...
    @EJB
    private Models.InventarioFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/config/Bundle").getString("InventarioCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/config/Bundle").getString("InventarioUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/config/Bundle").getString("InventarioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
