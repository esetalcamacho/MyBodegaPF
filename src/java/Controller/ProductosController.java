...
public class ProductosController implements Serializable {
    ...
    @EJB
    private Models.ProductosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/config/Bundle").getString("ProductosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/config/Bundle").getString("ProductosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/config/Bundle").getString("ProductosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
