...
public class RegistroController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/config/Bundle").getString("RegistroCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/config/Bundle").getString("RegistroUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/config/Bundle").getString("RegistroDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Registro getRegistro(java.lang.String id) {
    ...
    public static class RegistroControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Registro) {
                ...
                return getStringKey(o.getRegUserID());
            } else {
